...
//         目標、不在那裡開門，新乘客也不從那裡出發或去那裡（見 sim.js 的 blockFloor）。
...
export const EVENTS = [
  ...
  // 地板打蠟（#22）：唯一一列不生乘客、只改變樓的狀態的事件（n:[0,0]）。
  ...
  { id:'waxing', name:'地板打蠟', w:12, n:[0,0], at:'retail', to:'lobby',
    hours:[5,10], block:[18,30],
    text:'🧴 地板打蠟：{f} 樓封閉 {s} 秒，電梯不停靠' },
