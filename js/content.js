...
export const PASSENGERS = [
  ...
  // 零售帶的招牌角色（#27）。單價／耐性／佔位由 owner 指定，w 與 peaks 見下面的理由。
  //   w:16  —— 帶專屬人物今天落在 26–34（房客 30、住戶 34、觀景客 30、研究員 26）。
  //            零售帶的通用池是全樓最大的（上班族 w:100 在這裡不打折），而且**網紅
  //            送達後會再招來同伴**，實際看到的量會比 w 說的多一倍以上，所以基準值
  //            取在那個家族的一半以下，讓「含同伴」之後才落回 26–34 這一格。
  //   peaks —— 窗 [11,21] 是**照抄零售帶自己的** up:[11,20] / down:[11,21] 的聯集，
  //            不是第四套獨立作息：網紅的節奏就是商場的節奏。
  //            16×2.4 = 38.4（開店時段是帶專屬人物裡最顯眼的），關店後回到 16。
  { id:'influencer',name:'網紅排隊客', fare:1.4, patience:40, size:1, w:16, band:'retail',
